        ...
        {authUser && (
          <>
            {authUser.role != "instructor" && (
              <>
                <Link to={'/become-educator'} className='text-[16px] link link-hover text-neutral-600 font-normal'>
                  Become Educator
                </Link>
                |
              </>
            ...
            <Link className='text-[16px] link link-hover text-neutral-600 font-normal'>
              My Enrollments
            </Link>
